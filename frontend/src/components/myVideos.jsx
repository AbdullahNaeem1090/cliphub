...
// import TryPlaylistBox from "./dummy";
...
//         className={
//           plCard
//             ? " fixed z-50 top-[45%] md:left-[50%] left-[23%]  w-52 text-sm font-medium  rounded-lg bg-black bg-opacity-70 border-gray-600"
//             : "hidden"
//         }
//       >
//         <button
...
//       className="w-full px-4 py-2 font-medium text-left rtl:text-right cursor-pointer hover:bg-white hover:bg-opacity-5 text-gray-300 flex justify-between items-center"
//     >
...
//         //   );
//         // }}
//         className="form-checkbox text-blue-500 rounded-md bg-gray-800 border-gray-600"
//       />
//     </button>
//   ))}
